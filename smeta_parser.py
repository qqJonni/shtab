...
_HEADER_SYNONYMS: dict[str, list[str]] = {
    'name': [
        'наименование работ', 'наименование (вид работ)', 'наименование позиции',
        'наименование', 'вид работ', 'виды работ', 'состав работ', 'описание работ',
        'описание', 'работы', 'наим.', 'наим', 'name',
    ],
    'unit': [
    ...
    'unit_price': [
        'цена за единицу', 'цена за ед.', 'цена за ед', 'стоимость единицы',
        'стоимость ед.', 'стоимость ед', 'ед. цена', 'цена ед.',
        'расценка за ед.', 'расценка', 'цена', 'price',
    ],
    'total': [
        'общая стоимость', 'итого стоимость', 'общая сумма', 'стоимость работ',
        'сумма работ', 'итого, руб', 'итого руб', 'стоимость', 'итого',
        'сумма', 'всего', 'total',
    ],
}
